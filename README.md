...
As part of an external audit (Big 4 consulting firm), I performed a line-by-line review of **526 real estate records**, identifying **6 data anomalies**:
...
├── README.md
├── power_query/
│   ├── 01_file_selector.md        ← SharePoint file selection logic (annotated)
...
└── docs/
    ...
    └── dashboard_preview.png      ← Dashboard screenshot (anonymised)
```
